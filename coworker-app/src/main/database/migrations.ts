...
/**
 * Migration V9: Add short_description to coworkers
 */
function runMigrationV9(sqlite: Database.Database): void {
  console.log("[DB] Running migration V9: Add short_description to coworkers");
